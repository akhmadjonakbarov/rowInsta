...
class AppViewsScreen extends StatefulWidget {
  const AppViewsScreen({Key? key}) : super(key: key);

  @override
  ViewsState createState() => ViewsState();
}

class ViewsState extends State<AppViewsScreen> {
  ...
  Future<UpiResponse> initiateTransaction(UpiApp app) async {
    return _upiIndia.startTransaction(
      app: app,
      receiverUpiId: "9696227984@paytm",
      receiverName: 'Mr Shivam Dwivedi',
      transactionRefId: 'TestingVersion',
      transactionNote: 'This is Testing Mood',
      amount: 1.00,
    );
  } */
            ...
            children: [
              ...
              Container(
                ...
                child: GridView.count(
                  ...
                  childAspectRatio:
                      2/3 , // Width-to-height ratio of each grid item
